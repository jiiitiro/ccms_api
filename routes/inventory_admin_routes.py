...
from models import InventoryAdminLogin
...
def send_reset_email(email, reset_token, name):
    ...
    body = f"""
        ...
        <body>
            <div class="container">
                <h1>Dear {name},</h1>
                <p>Click the following link to reset your password:  <a href="{BASE_URL}/inventory/admin/reset-password/{reset_token}">Reset Password</a></p>
